"""Experiment stages for Does Safety RL Work by Changing What Models Explore."""
...
from .rlexplore._util import ensure_dir, stage_result, write_json
...
def stage_report(cfg: DictConfig, run_dir: Path) -> dict[str, Any]:
    ...
    write_json(
        out / "report.json",
        {"headline": "Does Safety RL Work by Changing What Models Explore", "claims_gated": True},
    )
