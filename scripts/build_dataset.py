...
script, so adding a source means registering a function, not editing a CLI::
    ...
    # src/rlexplore/data/__init__.py
...
def _registered_builder(name: str):
    ...
    try:
        module = importlib.import_module("rlexplore.data")
...
def main(argv: list[str] | None = None) -> int:
    ...
    from rlexplore.utils.run_manifest import utc_now_iso, write_json_atomic
    ...
    if builder is not None:
        ...
        source = f"rlexplore.data.BUILDERS[{data.name!r}]"
        ...
        print(
            ...
            "src/rlexplore/data/__init__.py under BUILDERS, or use data=synthetic "
